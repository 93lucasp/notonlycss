<template>
  <Layout>
    ...
    <p class="text-lg md:text-xl mb-12 font-light">Our articles are published on Medium, we write for free and only Medium through the <a href="https://medium.com/creators" target="_blank" rel="noopener noreferrer" class="underline">Medium Partner Program</a> allows us to earn money for the commitment.<br></p>
    ...
    <ul class="flex items-center mb-12">
      <li>
        ...
        <li class="mx-4">
          <a href="https://twitter.com/NotOnlyCSS" target="_blank" rel="noopener noreferrer"><i class="fab fa-twitter md:text-3xl"></i></a>
        </li>
        <li>
          <a href="https://medium.com/notonlycss" target="_blank" rel="noopener noreferrer"><i class="fab fa-medium-m md:text-3xl"></i></a>
        </li>
    </ul>
     <h1 class="text-3xl md:text-4xl font-bold mb-3">Write for us <i class="fas fa-pencil-alt ml-2 text-2xl"></i></h1>
    <p class="text-lg md:text-xl mb-16 font-light">We are always looking for talended writers, if you would like to write for us just drom us few line <a href="mailto:info@notonlycss.com" class="underline font-bold">here</a> </p>
  </Layout>
</template>
